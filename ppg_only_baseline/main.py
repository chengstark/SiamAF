...
from dataset import Dataset_per_file, Dataset_PPG, Dataset_ori
...
subset = 0
COMMENT = 'bs=2500SGD'
MODEL_FOLDER = f'corrected_res34_epoch_{NUM_EPOCHS}_ppglr_{PPG_LR}_lambda_{LAMBDA}_{COMMENT}'
...
if __name__=='__main__':
    ...
    train_dataset = Dataset_PPG('/labs/hulab/stark_stuff/ppg_ecg_project/data/', split='train', subset=subset)
