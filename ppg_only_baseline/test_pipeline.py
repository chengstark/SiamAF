...
def test_epoch(PPG_model, test_loader, test_ds_name, baseline=False, patient_info_path=None):
    with torch.no_grad():
        ...
        if patient_info_path is not None:
            ...
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_ppgonly_aurocs.npy', all_bt_aurocs)
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_ppgonly_auprcs.npy', all_bt_auprcs)
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_ppgonly_targets.npy', all_bt_targets)
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_ppgonly_pred_probs.npy', all_bt_pred_probs)
...
MODEL_PATH = '/home/zguo30/ppg_ecg_proj/ppg_only_baseline/saved_models/corrected_res34_epoch_30_ppglr_0.0001_lambda_0.9_bs=5000/PPG_best_5.pt'
...
# %% [markdown]
# # Adam val loss: 0.1524586140363407 F1:0.9438134240343055 -- Chose Adam
# # SGD   val loss: o.1560520457627926 F1: 0.941880586226172

# %% [markdown]
# # BS 2500 [VAL] Epoch 2 Loss: 0.15274458761606782, 	PPG F1: 0.943142797548075
# 
# 
# # BS 5000 [VAL] Epoch 5 Loss: 0.1524586140363407, 	PPG F1: 0.9438134240343055 -- Chose BS 5000
# 
