...
from dataset import Dataset_per_file, Dataset_ECG
...
LAMBDA = 0.9
subset = 0
MODEL_FOLDER = f'corrected_epoch_{NUM_EPOCHS}_ecglr_{ECG_LR}_lambda_{LAMBDA}'
...
if __name__=='__main__':
    ...
    train_dataset = Dataset_ECG('/labs/hulab/stark_stuff/ppg_ecg_project/data/', split='train', subset=subset)
