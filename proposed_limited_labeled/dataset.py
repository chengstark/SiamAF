...
class Dataset_whole_limited_labeled(Dataset):
    ...
    def build_dataset(self):
        ...
        if self.labeled_perc != 1:
            ...
            self.AF_idxs = np.tile(self.AF_subsample_idx, int(1/self.labeled_perc)+1)[:self.AF_ECG.shape[0]]
            self.PVC_idxs = np.tile(self.PVC_subsample_idx, int(1/self.labeled_perc)+1)[:self.PVC_ECG.shape[0]]
            self.NSR_idxs = np.tile(self.NSR_subsample_idx, int(1/self.labeled_perc)+1)[:self.NSR_ECG.shape[0]]
