...
#             print(PPG_feature.shape, PPG_out.shape)
        ...
        if patient_info_path is not None:
            ...
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_deepmilimitedlabels_aurocs.npy', all_bt_aurocs)
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_deepmilimitedlabels_auprcs.npy', all_bt_auprcs)
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_deepmilimitedlabels_targets.npy', all_bt_targets)
            np.save(f'/labs/hulab/stark_stuff/ppg_ecg_project/data/{test_ds_name}_deepmilimitedlabels_pred_probs.npy', all_bt_pred_probs)
...
# %%
state_dict = torch.load('/home/zguo30/ppg_ecg_proj/deepmi_limited_labels/saved_models/corrected_epoch_40_ecglr_0.0001_ppglr_0.0001_lambda_0.9_LABEL_PERC_0.01/PPG_best_23.pt') 
...
# %%
state_dict = torch.load('/home/zguo30/ppg_ecg_proj/deepmi_limited_labels/saved_models/corrected_epoch_40_ecglr_0.0001_ppglr_0.0001_lambda_0.9_LABEL_PERC_0.01/ECG_best_23.pt') 
from collections import OrderedDict
