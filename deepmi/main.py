...
from dataset import Dataset_per_file, Dataset_whole
...
subset = 0
comment = 'SGD'
MODEL_FOLDER = f'corrected_epoch_{NUM_EPOCHS}_ecglr_{ECG_LR}_ppglr_{PPG_LR}_lambda_{LAMBDA}_comment_{comment}'
...
if __name__=='__main__':
    ...
    train_dataset = Dataset_whole('/labs/hulab/stark_stuff/ppg_ecg_project/data/', split='train', subset=subset)
    ...
    PPG_optimizer = optim.SGD(PPG_model.parameters(), lr=0.1, momentum=0.9)
    ECG_optimizer = optim.SGD(ECG_model.parameters(), lr=0.1, momentum=0.9)
